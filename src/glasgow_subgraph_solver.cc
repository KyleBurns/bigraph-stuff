...
auto main(int argc, char * argv[]) -> int
{
    try {
        ...
        auto graphs = make_pair(
            read_pattern_file_format(pattern_format_name, options_vars["pattern-file"].as<string>()),
            read_target_file_format(target_format_name, options_vars["target-file"].as<string>()));
