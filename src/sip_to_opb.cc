...
auto main(int argc, char * argv[]) -> int
{
    try {
        ...
        auto pattern = read_pattern_file_format(default_format_name, options_vars["pattern-file"].as<string>());
        auto target = read_target_file_format(default_format_name, options_vars["target-file"].as<string>());
